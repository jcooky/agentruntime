...
type AgentSkill struct {
	...
	Server  string   `json:"server,omitempty" jsonschema_description:"MCP server name"`
	...
	Name        string `json:"name,omitempty" jsonschema_description:"name for LLM tool or native tool"`
